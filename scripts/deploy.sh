...
app_spec_content_string = $(jq -nc \
   ...
   '{version:1, Reesources: [{TargetService: {Type: AWS::ECS::Service", Properties:
    {TaskDefinition: $task_definition_arn, LoadBalancerInfo: ${ContainerName: $container_name, ContainerPort: $container_port }}}}]}')
